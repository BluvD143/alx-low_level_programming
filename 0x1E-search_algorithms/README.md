...
### [Task 0. Linear search](./0-linear.c)
...
### [Task 1. Binary search](./1-binary.c)
...
### [Task 8. Big O #5](./101-O)
* What is the time complexity (average case) of a jump search in an array of size n, using step = sqrt(n)?


### [Task 9. Interpolation search](./102-interpolation.c)
...
### [Task 10. Exponential search](./103-exponential.c)
...
### [Task 11. Advanced binary search](./104-advanced_binary.c)
...
### [Task 12. Jump search in a singly linked list](./105-jump_list.c)
...
### [Task 13. Linear search in a skip list](./106-linear_skip.c)
...
### [Task 14. Big O #6](./107-O)
* What is the time complexity (average case) of a jump search in a singly linked list of size n, using step = sqrt(n)?


### [Task 15. Big O #7](./108-O)
